...
export DEGRAF_INTERPONET_UPSAMPLE_MODE="${DEGRAF_INTERPONET_UPSAMPLE_MODE:-opencv_cubic}"
...
echo "[INFO] DEGRAF_INTERPONET_UPSAMPLE_MODE=${DEGRAF_INTERPONET_UPSAMPLE_MODE}"
